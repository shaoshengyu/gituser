...
<body>
	...
	<div class="addhouse">
		<h3>上传房源信息</h3>    <br>
		<form  name="theform" method="post" action="${pageContext.request.contextPath}/media/addHouse" enctype="multipart/form-data">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;房主号:<input type="text" name="ownerid" id="ownerid"><br><br>
