...
<body >
	...
	<div class="housesearch">
    	...
    	<form action="${pageContext.request.contextPath}/user/ownhouse" name="theform" method="post">
	...
	<div class="housesearch_showhouse">
		...
		<div class="housesearch_houseinfo">
			...
			<a class="uptran"  href="${pageContext.request.contextPath}/user/transaction?houseid=${house.houseid}">上传交易信息</a>
		</div>	
	</div>
	</c:forEach>
</body>
